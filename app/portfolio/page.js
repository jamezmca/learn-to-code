    ...
    return (
        <MainWrapper>
            ...
            <div className='flex flex-col sm:flex-row sm:items-stretch gap-8 text-blue-300'>
                <img className='rounded-full w-32' src='https://media.licdn.com/dms/image/C5603AQG6Q4W3kWANtw/profile-displayphoto-shrink_200_200/0/1630988413596?e=1710979200&v=beta&t=2NWxj6fDhf5FzDSV0MOa50L6n24CczeA1RbVFmUXTRA' alt='profile-img' />
