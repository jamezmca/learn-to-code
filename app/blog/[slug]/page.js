...
export async function generateMetadata({ params, searchParams }, parent) {
    ...
    return {
        title: `Smoljames ⋅ Blog${id.replaceAll('_', ' ')}`,
    }
}
    ...
    return (
        <MainWrapper>
            <div className="flex flex-col">
                <Link href={'/blog'} className="relative mr-auto overflow-hidden group hover:after:translate-x-full after:duration-200 after:absolute after:top-0 after:h-full after:w-full after:right-full after:bg-blue-100 after:z-[-1]">
