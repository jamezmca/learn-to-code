...
- [JavaScript · Course Notes](#javascript--course-notes)
      - [The ultimate guide to *JavaScript Algorithms \& Data Structures* 🔥](#the-ultimate-guide-to-javascript-algorithms--data-structures-)
  - [Resources](#resources)
  ...
  - [Chapter 2 - Basic JavaScript Syntax and Concepts](#chapter-2---basic-javascript-syntax-and-concepts)
    - [2.1 Basic JavaScript Syntax](#21-basic-javascript-syntax)
      - [2.1.1 Variable \& Declarations](#211-variable--declarations)
      - [2.1.1.1 Assignment By Reference](#2111-assignment-by-reference)
      - [2.1.2 Data Types](#212-data-types)
      - [2.1.3 JavaScript Operators](#213-javascript-operators)
      - [2.1.4 Commenting in JavaScipt](#214-commenting-in-javascipt)
    - [2.2 Control Flow with Conditional Statements \& Loops](#22-control-flow-with-conditional-statements--loops)
      - [2.2.1 The For Loop](#221-the-for-loop)
      - [2.2.2 The While Loop](#222-the-while-loop)
      - [2.2.3 If Statements](#223-if-statements)
    - [2.3 Basic Functions in JavaScript](#23-basic-functions-in-javascript)
      - [2.3.1 When to use Functions](#231-when-to-use-functions)
      - [2.3.2 The Anatomy of a Function](#232-the-anatomy-of-a-function)
      - [2.3.3 Invoking a Function](#233-invoking-a-function)
      - [2.3.4 Function Returns](#234-function-returns)
      - [2.3.4 Recursion](#234-recursion)
  - [Chapter 3 - Intermediate Programming Skills with JavaScript](#chapter-3---intermediate-programming-skills-with-javascript)
    - [3.1 Data Manipulation](#31-data-manipulation)
      - [3.1.1 Modifying Strings](#311-modifying-strings)
        - [3.1.1.1 Regex](#3111-regex)
      - [3.1.2 Modifying Arrays and Lists](#312-modifying-arrays-and-lists)
      - [3.1.3 Modifying Objects / Dictionaries](#313-modifying-objects--dictionaries)
      - [3.1.3.1 JSON](#3131-json)
    ...
    - [3.2 Scope, closures, and how to write modular and reusable code.](#32-scope-closures-and-how-to-write-modular-and-reusable-code)
      - [3.2.1 Scope in JavaScript](#321-scope-in-javascript)
      - [3.2.2 Closures in JavaScript](#322-closures-in-javascript)
      - [3.2.3 Modular Code in JavaScript](#323-modular-code-in-javascript)
  ...
  - [Chapter 6 - Learn the Modern ES6+ JavaScript Syntax](#chapter-6---learn-the-modern-es6-javascript-syntax)
    - [6.1 Arrow Functions](#61-arrow-functions)
      - [6.1.1 Anonymous Functions](#611-anonymous-functions)
    ...
    - [6.7 Short Circuits (\&\& || ??)](#67-short-circuits---)
      - [6.7.1 AND Short Circuit (\&\&)](#671-and-short-circuit-)
      - [6.7.2 OR Short Circuit (||)](#672-or-short-circuit-)
      - [6.7.3 Nullish Coalescing (??)](#673-nullish-coalescing-)
